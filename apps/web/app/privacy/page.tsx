  ...
  return (
    <main className="mx-auto max-w-4xl px-6 py-12">
      <div className="space-y-10">
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-semibold text-gray-900">
            Money transfer providers and external websites
          </h2>
          ...
          <p className="leading-7 text-gray-600">
            The provider&apos;s own privacy policy and terms apply to
            information you provide after visiting its website or using its
            services.
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p className="leading-7 text-gray-600">
            ...
            and meeting applicable legal obligations.
          </p>

          <p className="leading-7 text-gray-600">
            We use reasonable technical and organizational measures intended to
            protect information. However, no internet service or method of
        ...
        <section className="space-y-4">
          ...
          <p className="leading-7 text-gray-600">
            ...
            personal information, which may include requesting access,
