      ...
      <div className="space-y-10">
        <header>
          ...
          <p className="mt-4 max-w-3xl text-lg leading-8 text-gray-600">
            PagoSync helps users compare international money transfer
            ...
            come from current provider-supplied data and which are PagoSync
            estimates.
          </p>
        </header>
        ...
        <section className="space-y-4">
          ...
          <p className="leading-7 text-gray-600">
            ...
            that data is available to PagoSync. Results labelled ESTIMATE are
            comparison estimates calculated by PagoSync and may differ from
        ...
        <section className="space-y-4">
          ...
          <p className="leading-7 text-gray-600">
            Where available, PagoSync considers the exchange rate and any
        ...
        <section className="space-y-4">
          ...
          <p className="leading-7 text-gray-600">
            By default, PagoSync can rank available results by recipient
        ...
        <section className="rounded-2xl border border-gray-200 bg-gray-50 p-6">
          ...
          <p className="mt-3 leading-7 text-gray-600">
            PagoSync is a comparison platform. We do not send, hold or receive
